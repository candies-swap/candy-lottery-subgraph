...
export class Lottery__viewLotteryResultValue0Struct extends ethereum.Tuple {
  ...
  get candyPerBracket(): Array<BigInt> {
  ...
  get amountCollectedInCandy(): BigInt {
...
export class Lottery extends ethereum.SmartContract {
  ...
  candyToken(): Address {
    let result = super.call("candyToken", "candyToken():(address)", []);

    return result[0].toAddress();
  }

  try_candyToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("candyToken", "candyToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  maxPriceTicketInCandy(): BigInt {
    let result = super.call(
      "maxPriceTicketInCandy",
      "maxPriceTicketInCandy():(uint256)",
      []
    );
  ...
  try_maxPriceTicketInCandy(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxPriceTicketInCandy",
      "maxPriceTicketInCandy():(uint256)",
      []
  ...
  minPriceTicketInCandy(): BigInt {
    let result = super.call(
      "minPriceTicketInCandy",
      "minPriceTicketInCandy():(uint256)",
      []
    );
  ...
  try_minPriceTicketInCandy(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "minPriceTicketInCandy",
      "minPriceTicketInCandy():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _candyTokenAddress(): Address {
...
export class SetMinAndMaxTicketPriceInCandyCall extends ethereum.Call {
  get inputs(): SetMinAndMaxTicketPriceInCandyCall__Inputs {
    return new SetMinAndMaxTicketPriceInCandyCall__Inputs(this);
  }

  get outputs(): SetMinAndMaxTicketPriceInCandyCall__Outputs {
    return new SetMinAndMaxTicketPriceInCandyCall__Outputs(this);
  }
}

export class SetMinAndMaxTicketPriceInCandyCall__Inputs {
  _call: SetMinAndMaxTicketPriceInCandyCall;

  constructor(call: SetMinAndMaxTicketPriceInCandyCall) {
    this._call = call;
  }

  get _minPriceTicketInCandy(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }

  get _maxPriceTicketInCandy(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
}

export class SetMinAndMaxTicketPriceInCandyCall__Outputs {
  _call: SetMinAndMaxTicketPriceInCandyCall;
...
export class StartLotteryCall__Inputs {
  ...
  get _priceTicketInCandy(): BigInt {
    return this._call.inputValues[1].value.toBigInt();
  }
